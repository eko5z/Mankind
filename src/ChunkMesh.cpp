...
/*
 ...
 v2 v3
*/
void ChunkMesh::PushFace(glm::vec3 v0, glm::vec3 v1, glm::vec3 v2, glm::vec3 v3, glm::vec3 norm)
{
	for (int i(0); i < 6; ++i) {
...
void ChunkMesh::Update()
{
	...
	this->mesh = std::make_unique<Mesh>(real_vertices, normals, uvs, indices, texture);
